...
define('OWA_DB_TYPE', '{{.OWA_DB_TYPE}}'); // options: mysql
define('OWA_DB_NAME', '{{.OWA_DB_NAME}}'); // name of the database
define('OWA_DB_HOST', '{{.OWA_DB_HOST}}'); // host name of the server housing the database
define('OWA_DB_USER', '{{.OWA_DB_USER}}'); // database user
define('OWA_DB_PASSWORD', '{{.OWA_DB_PASSWORD}}'); // database user's password
...
define('OWA_PUBLIC_URL', '{{.OWA_PUBLIC_URL}}');
...
define('OWA_ERROR_HANDLER', '{{.OWA_ERROR_HANDLER}}');
...
define('OWA_LOG_PHP_ERRORS', {{.OWA_LOG_PHP_ERRORS}});
...
define('OWA_CACHE_OBJECTS', {{.OWA_CACHE_OBJECTS}});
